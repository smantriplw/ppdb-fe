                                ...
                                <Form>
                                    <div className="text-center">
                                        <div className="join gap-4">
                                            <FormField label="NIK">
                                                <Field onChange={handleChange} disabled={isSubmitting} className="input max-w-xs w-full join-item" type="number" name="nik" placeholder="00XXXXXXXXXXXXX" required />
                                                {errors.nik && touched.nik ? (
                                                    <p className="text-red-500 join-item">{errors.nik}</p>
                                                ) : null}
                                            </FormField>
                                            <FormField label="NAMA">
                                                <Field onChange={handleChange} disabled={isSubmitting} className="input max-w-xs w-full join-item" type="text" name="name" placeholder="Contoh: Hanif Dwy Putra S" required />
                                                {errors.name && touched.name ? (
                                                    <p className="text-red-500 join-item">{errors.name}</p>
                                                ) : null}
                                            </FormField>
                                        </div>
                                        <div className="join gap-4">
                                            <FormField label="NAMA IBU">
                                                <Field onChange={handleChange} disabled={isSubmitting} className="input max-w-xs w-full join-item" type="text" name="mother_name" placeholder="Contoh: Puan Maharani" required />
                                                {errors.mother_name && touched.mother_name ? (
                                                    <p className="text-red-500 join-item">{errors.mother_name}</p>
                                                ) : null}
                                            </FormField>
                                            <FormField label="NAMA AYAH">
                                                <Field onChange={handleChange} disabled={isSubmitting} className="input max-w-xs w-full join-item" type="text" name="father_name" placeholder="Contoh: Erick Tohir" required />
                                                {errors.father_name && touched.father_name ? (
                                                    <p className="text-red-500 join-item">{errors.father_name}</p>
                                                ) : null}
                                            </FormField>
                                        </div>
                                        <div className="join gap-4">
                                            <FormField label="TTL">
                                                <Field onChange={handleChange} disabled={props.isNew ? isSubmitting : true} className="input max-w-xs w-full join-item" type="text" name="birthday" placeholder="Contoh: Palu, 24 Maret 2007" required />
                                                {errors.birthday && touched.birthday ? (
                                                    <p className="text-red-500 break-words join-item">{errors.birthday}</p>
                                                ) : null}
                                            </FormField>
                                            <FormField label="EMAIL">
                                                <Field onChange={handleChange} disabled={isSubmitting} className="input join-item max-w-xs w-full" type="email" name="email" placeholder="Masukan email aktif disini, contoh: hansputera@sman3palu.sch.id" required />
                                                {errors.email && touched.email ? (
                                                    <p className="text-red-500 join-item">{errors.email}</p>
                                                ) : null}
                                            </FormField>
                                        </div>
                                        <div className="join gap-4">
                                            <FormField label="NO. TELP">
                                                <Field onChange={handleChange} disabled={isSubmitting} className="input max-w-xs w-full join-item" type="tel" name="phone" placeholder="Masukan nomor telepon aktif untuk dihubungi. Contoh: 6281346757451" required />
                                                {errors.phone && touched.phone ? (
                                                    <p className="text-red-500 join-item">{errors.phone}</p>
                                                ) : null}
                                            </FormField>
                                            <FormField label="TAHUN LULUS">
                                                <Field onChange={handleChange} disabled={isSubmitting} className="input join-item max-w-xs w-full" type="number" name="graduated_year" placeholder="Kamu lulus SMP kapan? Contoh: 2019" required />
                                                {errors.graduated_year && touched.graduated_year ? (
                                                    <p className="text-red-500 join-item">{errors.graduated_year}</p>
                                                ) : null}
                                            </FormField>
                                        </div>
                                        <div className="join gap-4">
                                            <FormField label="ASAL SEKOLAH">
                                                <Field onChange={handleChange} disabled={isSubmitting} className="input join-item max-w-xs w-full" type="text" name="school" placeholder="Kamu asal sekolah mana? Masukin disini ya, contohnya: SMP Negeri 6 Palu" required />
                                                {errors.school && touched.school ? (
                                                    <p className="text-red-500 join-item">{errors.school}</p>
                                                ) : null}
                                            </FormField>
                                            <FormField label="ALAMAT">
                                                <Field onChange={handleChange} disabled={isSubmitting} className="input join-item max-w-xs w-full" type="text" name="address" placeholder="Kamu tinggal dimana? Masukin disini ya. Contohnya: Jl. Bikini Bottom, Blok 16" required/>
                                                {errors.address && touched.address ? (
                                                    <p className="text-red-500 join-item">{errors.address}</p>
                                                ) : null}
                                            </FormField>
                                        </div>
                                        <div className="join gap-4">
                                            <FormField label="GENDER">
                                                ...
                                                {errors.gender && touched.gender ? (
                                                    <p className="text-red-500 join-item">{errors.gender}</p>
                                                ) : null}
                                            </FormField>
                                            <FormField label="AGAMA">
                                                ...
                                                {errors.religion && touched.religion ? (
                                                    <p className="text-red-500 join-item">{errors.religion}</p>
                                                ) : null}
                                            </FormField>
                                        </div>
                                    </div>
